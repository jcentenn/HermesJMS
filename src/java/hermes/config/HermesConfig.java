...
// Generated on: 2014.08.19 at 10:59:39 PM EDT 
//
 ...
 *         &lt;element name="jmsSessionGroup" type="{}JMSSessionGroupConfig" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class HermesConfig {
    ...
    protected List<JMSSessionGroupConfig> jmsSessionGroup;
    @XmlAttribute
    ...
    /**
     * Gets the value of the jmsSessionGroup property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the jmsSessionGroup property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getJmsSessionGroup().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link JMSSessionGroupConfig }
     * 
     * 
     */
    public List<JMSSessionGroupConfig> getJmsSessionGroup() {
        if (jmsSessionGroup == null) {
            jmsSessionGroup = new ArrayList<JMSSessionGroupConfig>();
        }
        return this.jmsSessionGroup;
    }
